SELECT DISTINCT s.subject_name  AS course_name, stu.student_id, stu.first_name || ' ' || stu.last_name AS full_name, s.subject_name, t.teacher_id, t.first_name || ' ' || t.last_name as full_name_teacher  
FROM grades g
